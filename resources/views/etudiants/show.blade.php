...
<div class="container mx-auto py-6 px-4">
    ...
    <form method="GET" action="{{ route('etudiants.show', ['etudiant' => $etudiant->id]) }}" class="mb-6 bg-white shadow-lg rounded-lg p-6">
    <label for="semestre" class="block text-lg font-medium text-gray-700 mb-2">Choisie un semestre et filtre pour voir tous les etudiants associés a ce semestre et le resultats par semestre de l'etudiant selectionner:</label>
            ...
            <tbody>
                @forelse($etudiants as $etudiant)
                    <tr class="hover:bg-gray-50">
                        ...
                        <a href="{{ route('resultats.semestre', ['etudiantId' => $etudiant->id, 'semestre' => $semestre]) }}"
   class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-200">
    Voir les résultats du Semestre {{ $semestre }}
</a>
